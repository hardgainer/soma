...
if __name__ == '__main__':
    # b = move(fa, (3,2,0))
    # print(b, '\n')
    # pos_f = gen_rotations_24(fv)
    # pprint(pos_f)
    # print()
    cube = gen_space(3)
    # pprint(gen_valid_positions(fv, cube))
    # print()
    # f_all = gen_all_positions(fz, cube)
    # pprint(f_all)
    # print(len(f_all))
    ...
    print(lens)
    print('Number of variants:', reduce(lambda x,y: x*y, lens))
    ...
    #sol = [16420,263681,131520,100761600,9963520,4122,23076864]
    # sol = [5632,23330816,131520,100761600,9963520,16422,8217]
    # sol = [4609,23330816,456,100761600,9963520,155664,1062]
    # sol = [4609,23330816,456,100761600,9963520,9222,147504]
    # sol = [4609,23330816,33216,147492,9963520,100737024,1050]
    # sol = [16420,263681,67240320,33652800,9963520,4122,23076864]
    fig_num = 0
    for n in sol:
        figure = []
        for i in range(27):
